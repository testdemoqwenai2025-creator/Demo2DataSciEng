...
print("=" * 60)`} buttonLabel="Run feature store simulation (Pyodide)" />
      ...
      <NextSteps relatedPages={[{ id: "connections" as const, reason: "Trace this topic's connections across the platform's math graph" }, { id: "ml-platform" as const, reason: "Continue to ml platform — see also from this page" }, { id: "model-registry" as const, reason: "Continue to model registry — see also from this page" }]} />
