...
└─ No  → revisit Q1`}
      ...
      <DeeperThoughtSection pageTitle="Modern Big Data Stack">
        <DeeperThought title="Modern Big Data Stack IS part of a larger system — no page stands alone" connectedTo="ADR-001 (platform architecture)">
          <p>{"This page about Modern Big Data Stack is not an isolated reference — it's a node in a graph. The platform's thesis is that the same math appears across genomics, fintech, maritime, and audio. Modern Big Data Stack connects to the elegant-code cards via shared equations, and to the living-equation pages via live demos. The reader who arrives here looking for facts leaves with a map of where Modern Big Data Stack sits in the computational-science landscape."}</p>
        </DeeperThought>
      ...
      <NextSteps relatedPages={[{ id: "connections" as const, reason: "Trace this topic's connections across the platform's math graph" }, { id: "databricks" as const, reason: "Continue to databricks — see also from this page" }, { id: "evolution" as const, reason: "Continue to evolution — see also from this page" }]} />
