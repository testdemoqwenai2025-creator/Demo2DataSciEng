...
└──────────────────────────────────────────────────────────────────────────┘`} />
      ...
      <SectionCard
        title="Cross-disciplinary elegant-code cards — the math behind macro structures"
        description="SVD (structural decomposition), Attention (AlphaFold2 structure prediction), and Entropy (structural diversity) all apply to macro-structure analysis. Each card shows the same math applied across 3+ sciences."
        icon={<Sparkles className="h-5 w-5" />}
        badge="elegant code"
      >
        <DatasetCards
          examples={ELEGANT_CODE_CARDS.filter((_, i) => [0, 1, 9].includes(i))}
          intro="SVD (structural decomposition), Attention (AlphaFold2 structure prediction), and Entropy (structural diversity) all apply to macro-structure analysis. Each card shows the same math applied across 3+ sciences."
        />
      </SectionCard>
