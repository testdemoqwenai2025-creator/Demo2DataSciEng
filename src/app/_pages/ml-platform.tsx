...
predictions = model.predict(new_data)`}
      ...
      <NextSteps relatedPages={[{ id: "connections" as const, reason: "Trace this topic's connections across the platform's math graph" }, { id: "knowledge" as const, reason: "Continue to knowledge — see also from this page" }, { id: "polars" as const, reason: "Continue to polars — see also from this page" }]} />
