...
governance:
  ...
  rls: "SESSION_CONTEXT('ROW_ACCESS_REGION')"`}
      ...
      <NextSteps relatedPages={[{ id: "connections" as const, reason: "Trace this topic's connections across the platform's math graph" }, { id: "patterns" as const, reason: "Continue to patterns — see also from this page" }, { id: "governance" as const, reason: "Continue to governance — see also from this page" }]} />
