...
const PAGE_TOPICS: Record<PageId, PageTopic> = {
  ...
  "fivetran-hightouch":  { topic: "Fivetran Hightouch ELT reverse-ETL data activation",              label: "ELT + rETL",    codeRepo: "airbytehq/airbyte/master/README.md" },
  ...
  "tableau":             { topic: "Tableau analytics BI dashboard row-level security semantic layer", label: "Tableau",       codeRepo: "tableau/server-client-python/master/README.md" },
  ...
  "evolution":           { topic: "technology radar Thoughtworks data engineering roadmap",          label: "Evolution",     codeRepo: "githubtraining/githubian/main/README.md" },
  "research":            { topic: "MapReduce Delta Lake Kimball dimensional modelling Lakehouse",    label: "Research",      codeRepo: "apache/spark/master/README.md" },
  ...
  "streaming":           { topic: "Apache Kafka Flink Pulsar streaming Lambda Kappa architecture",     label: "Streaming",     codeRepo: "apache/flink/master/README.md" },
  ...
  "data-mesh":            { topic: "data mesh domain-oriented data products federated governance",      label: "Data Mesh",      codeRepo: "Netflix/data_mesh/main/README.md" },
  ...
  "ml-platform":         { topic: "MLflow machine learning MLOps model registry feature store inference", label: "ML Platform",   codeRepo: "mlflow/mlflow/master/README.md" },
  ...
  "feature-store":       { topic: "feature store online offline train serve consistency Feast",        label: "Feature Store",  codeRepo: "feast-dev/feast/master/README.md" },
  "model-registry":      { topic: "MLflow model registry versioning staging production archived",      label: "Model Registry", codeRepo: "mlflow/mlflow/master/README.md" },
  ...
  "rag-llms":            { topic: "RAG retrieval augmented generation vector database embeddings LLM", label: "RAG & LLMs",     codeRepo: "langchain-ai/langchain/master/README.md" },
  "vector-db":           { topic: "pgvector Pinecone Weaviate Qdrant vector database HNSW cosine similarity",  label: "Vector DBs",    codeRepo: "pgvector/pgvector/master/README.md" },
  "rl-agentic":          { topic: "reinforcement learning Q-learning PPO policy gradient agentic AI agents",  label: "RL & Agents",   codeRepo: "openai/gym/master/README.md" },
  ...
  "comp-sci-materials":  { topic: "computational science materials chemistry silicon GPU semiconductor LLM hardware", label: "Comp Sci",     codeRepo: "cmu-db/pdt/main/README.md" },
  ...
  "distributed-training": { topic: "distributed training DDP FSDP ZeRO AllReduce Ring AllReduce PyTorch multi-GPU",      label: "Distributed",   codeRepo: "pytorch/pytorch/master/README.md" },
  ...
  "rag-deep-dive":         { topic: "RAG retrieval augmented generation hybrid BM25 vector cross-encoder re-rank chunking RRF",      label: "RAG",           codeRepo: "langchain-ai/langchain/master/README.md" },
  ...
  "cheminformatics":         { topic: "cheminformatics ECFP fingerprint Tanimoto similarity ChemBERTa RDKit SMILES molecular virtual screening drug discovery",      label: "Cheminformatics", codeRepo: "rdkit/rdkit/master/README.md" },
  "molecular-modelling":      { topic: "molecular dynamics force field AMBER CHARMM Verlet integration E(n)-equivariant neural network AlphaFold3 SchNet Equiformer",      label: "Molecular Mod.",  codeRepo: "openmm/openmm/master/README.md" },
  "genetic-materials":         { topic: "genetics DNA RNA CRISPR Cas9 GWAS HMM Viterbi BLOSUM ENCODE GTEx UK Biobank BWA GATK genomics",      label: "Genetics",       codeRepo: "samtools/bcftools/master/README.md" },
  ...
  "systems-biology":           { topic: "systems biology FBA flux balance analysis metabolic network PPI STRING multi-omics MOFA whole-cell COBRApy",      label: "Systems Biology", codeRepo: "opencobra/cobrapy/master/README.rst" },
  "cryo-em":                    { topic: "cryo-EM RELION CryoSPARC cryoDRGN Fourier projection-slice CTF Radon transform single particle analysis",      label: "Cryo-EM",        codeRepo: "zhudio/cryodrgn/master/README.md" },
  "spatial-transcriptomics":    { topic: "spatial transcriptomics Visium MERFISH Stereo-seq STAGATE NicheNet combinatorial barcoding U-Net cell segmentation",      label: "Spatial Tx",    codeRepo: "theislab/scvi-tools/master/README.md" },
  "singlecell-multiomics":      { topic: "single-cell multi-omics scVI WNN RNA velocity Harmony 10x Genomics scVelo Seurat multi-modal integration",      label: "Single-cell",   codeRepo: "scverse/scvi-tools/main/README.md" },
  ...
  "ai-drug-discovery":           { topic: "AI drug discovery Insilico Medicine Recursion Chemistry42 generative chemistry phenomics ADMET clinical candidate ISM042 Atomwise",      label: "AI Drug",       codeRepo: "openai/improved-diffusion/master/README.md" },
  "spatial-multiomics":         { topic: "spatial multi-omics DBiT-seq spatial-CUT&Tag chromatin histone marks H3K4me3 H3K27me3 Spatial ATAC-RNA cross-attention STAGATE",      label: "Spatial Multi",  codeRepo: "theislab/scvi-tools/master/README.md" },
  "coevolution-dca":           { topic: "Direct Coupling Analysis DCA co-evolution mutual information Potts model mean-field covariance inverse AlphaFold attention equivalence contact prediction",      label: "Co-evo & DCA",   codeRepo: "facebookresearch/esm/master/README.md" },
  "neural-network-potentials": { topic: "neural network potential SchNet DimeNet GemNet NequIP MACE SO(3) representation theory Clebsch-Gordan spherical harmonics body-order QM9",      label: "NN Potentials",   codeRepo: "mir-group/SchNet/master/README.md" },
  "enhanced-sampling":          { topic: "enhanced sampling metadynamics REMD replica exchange Markov state model MSM TICA neural ODE free energy rare events molecular dynamics",      label: "Enh. Sampling",   codeRepo: "openmm/openmm/master/README.md" },
  "generative-chemistry-2":     { topic: "generative chemistry EDM diffusion DiffDock GFlowNet Sinkhorn optimal transport Wasserstein 3D molecule generation",      label: "Gen Chem 2.0",    codeRepo: "openai/improved-diffusion/master/README.md" },
  ...
  "space-science":                { topic: "space science exoplanets transit method gravitational waves LIGO LHC CERN jet classification JWST Kepler TESS",      label: "Space Science", codeRepo: "astropy/astropy/main/README.rst" },
  "fintech":                       { topic: "fintech Black-Scholes Monte Carlo Ito lemma VaR CVaR algorithmic trading LSTM fraud detection GNN blockchain DeFi",      label: "Fintech",      codeRepo: "quantopian/pyfolio/master/README.md" },
};
